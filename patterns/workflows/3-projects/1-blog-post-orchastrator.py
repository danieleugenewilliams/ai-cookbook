...
class BlogOrchestrator:
    """Orchestrator for blog writing workflow"""
...
if __name__ == "__main__":
    ...
    """Get contents of lessons learned document"""
    with open(
        "/Users/danielwilliams/Projects/ai-cookbook/patterns/workflows/2-workflow-patterns/lessons-learned.md",
        "r",
    ) as f:
        lessons_learned_doc = f.read()
    topic = lessons_learned_doc
